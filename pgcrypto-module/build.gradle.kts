...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "sqldelight-pgcrypto"
            groupId = project.group.toString()
            version = project.version.toString()

            pom {
                name.set("SQLDelight Pgcrypto Module")
                description.set("SQLDelight module for Pgcrypto support")
                url.set("https://github.com/griffio/sqldelight-pgcrypto-module-app")
                ...
                scm {
                    connection.set("scm:git:git://github.com/griffio/sqldelight-pgcrypto-module-app.git")
                    developerConnection.set("scm:git:ssh://github.com/griffio/sqldelight-pgcrypto-module-app.git")
                    url.set("https://github.com/griffio/sqldelight-pgcrypto-module-app")
                }
            }
        }
...
jreleaser {
    gitRootSearch = true
    project {
        description = "SQLDelight module for pgcrypto support"
